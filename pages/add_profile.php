    ...
    <div class="container">
        ...
        <div class="action-pannel">
            <div class="action-center">
                <form id="profile" method="post" action="<?= get_url() ?>formdata.php" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <table style="width: 100%;">
                                ...
                                <tr>
                                    ...
                                    <td><label for="Foreigner"><input type="checkbox" name="cat_[]" id="Foreigner" value="Foreigner Escorts">Foreigner Escort</label></td>
                                ...
                                <tr>
                                    ...
                                    <td><label for="Lesbian"><input type="checkbox" name="cat_[]" id="Lesbian" value="Lesbian Girl">Lesbian</label></td>
